...
import com.stardevllc.nightconfig.core.concurrent.ConcurrentCommentedConfig;
import com.stardevllc.nightconfig.core.io.ConfigParser;
import com.stardevllc.nightconfig.core.io.ParsingException;
import com.stardevllc.nightconfig.core.io.ParsingMode;
...
public final class HoconParser implements ConfigParser<CommentedConfig> {
	...
	public ConfigFormat<CommentedConfig> getFormat() {
		return com.stardevllc.nightconfig.hocon.HoconFormat.instance();
	}

	@Override
	public CommentedConfig parse(Reader reader) {
		CommentedConfig config = com.stardevllc.nightconfig.hocon.HoconFormat.instance().createConfig();
	...
	private static Object unwrap(Object o) {
		if (o instanceof Map) {
			...
			return Config.wrap(unwrappedMap, com.stardevllc.nightconfig.hocon.HoconFormat.instance());
