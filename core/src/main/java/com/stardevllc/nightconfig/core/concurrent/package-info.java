 ...
 * {@link com.stardevllc.nightconfig.core.Config#inMemory() },
 ...
 * {@link com.stardevllc.nightconfig.core.Config#inMemoryConcurrent()},
 ...
 * {@link com.stardevllc.nightconfig.core.concurrent.ConcurrentConfig} (and its commented version
 * {@link com.stardevllc.nightconfig.core.concurrent.ConcurrentCommentedConfig}).
 * Classes that implement {@link com.stardevllc.nightconfig.core.concurrent.ConcurrentConfig} offer the
 ...
 * {@link com.stardevllc.nightconfig.core.concurrent.ConcurrentConfig#bulkRead(java.util.function.Function)},
 * {@link com.stardevllc.nightconfig.core.concurrent.ConcurrentConfig#bulkUpdate(java.util.function.Function)},
 * {@link com.stardevllc.nightconfig.core.concurrent.ConcurrentCommentedConfig#bulkCommentedRead(java.util.function.Function)}
 * and
 * {@link com.stardevllc.nightconfig.core.concurrent.ConcurrentCommentedConfig#bulkCommentedUpdate(java.util.function.Function)}.
 * </li>
 * </ul>
 *
 ...
 * </pre>
 *
 * Some configurations like {@link com.stardevllc.nightconfig.core.concurrent.StampedConfig} and {@link com.stardevllc.nightconfig.core.concurrent.SynchronizedConfig} also provide a way to atomically
 * replace their entire content. At the moment, this feature is not part of the {@link com.stardevllc.nightconfig.core.concurrent.ConcurrentConfig} interface.
 *
 ...
 * {@link com.stardevllc.nightconfig.core.concurrent.SynchronizedConfig#replaceContentBy(com.stardevllc.nightconfig.core.Config)}
 * for more information.</li>
 * </ol>
 *
 * @since 3.7.0
 */
package com.stardevllc.nightconfig.core.concurrent;
