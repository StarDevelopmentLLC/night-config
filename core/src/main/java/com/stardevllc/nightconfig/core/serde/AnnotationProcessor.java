...
import com.stardevllc.nightconfig.core.serde.annotations.SerdeAssert.AssertThat;
import com.stardevllc.nightconfig.core.serde.annotations.SerdeSkipDeserializingIf.SkipDeIf;
import com.stardevllc.nightconfig.core.serde.annotations.SerdeSkipSerializingIf.SkipSerIf;
import com.stardevllc.nightconfig.core.NullObject;
import com.stardevllc.nightconfig.core.serde.annotations.*;
...
import static com.stardevllc.nightconfig.core.serde.annotations.SerdePhase.*;
...
final class AnnotationProcessor {
	...
	static String annotToString(Annotation annotation) {
		return annotation.toString().replace("@com.stardevllc.nightconfig.core.serde.annotations.", "@");
	}
}
