package com.stardevllc.nightconfig.core;

import com.stardevllc.nightconfig.core.utils.TransformingSet;
...
/**
 * An abstract Config that uses a {@link Map} to store its values. In practice it's
